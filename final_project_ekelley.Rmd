...
knitr::opts_chunk$set(echo = FALSE, include = TRUE, eval = TRUE, warning = FALSE, message = FALSE, fig.pos = "!b", out.extra = "",fig.align = "left")
# fig.pos = "H", out.extra = "", fig.align = "left"
```

```{r, child=c('final_project_text.Rmd')}
```
